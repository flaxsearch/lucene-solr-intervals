...
public class IndexSearcher {
  ...
  public void search(Query query, Collector results)
    throws IOException {
    int flags = results.needsIntervals() ? PostingsEnum.OFFSETS : PostingsEnum.FREQS;
  ...
  */
  public <C extends Collector, T> T search(Query query, CollectorManager<C, T> collectorManager) throws IOException {
    if (executor == null) {
      ...
      final Weight weight = createNormalizedWeight(query, needsScores, PostingsEnum.FREQS);
  ...
  public Explanation explain(Query query, int doc) throws IOException {
    return explain(createNormalizedWeight(query, true, PostingsEnum.FREQS), doc);
  }
  ...
  public Weight createNormalizedWeight(Query query, boolean needsScores, int flags) throws IOException {
    query = rewrite(query);
    Weight weight = createWeight(query, needsScores, flags);
  ...
  public Weight createNormalizedWeight(Query query, boolean needsScores) throws IOException {
    return createNormalizedWeight(query, needsScores, needsScores ? PostingsEnum.FREQS : PostingsEnum.NONE);
  }
