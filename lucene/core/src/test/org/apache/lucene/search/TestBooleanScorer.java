  ...
  private static class CrazyMustUseBulkScorerQuery extends Query {
    ...
    public Weight createWeight(IndexSearcher searcher) throws IOException {
      return new Weight() {
        ...
        @Override
        public Scorer scorer(LeafReaderContext context, PostingFeatures flags, Bits acceptDocs) {
          throw new UnsupportedOperationException();
        }

        @Override
        public BulkScorer bulkScorer(LeafReaderContext context, boolean scoreDocsInOrder, PostingFeatures flags, Bits acceptDocs) {
