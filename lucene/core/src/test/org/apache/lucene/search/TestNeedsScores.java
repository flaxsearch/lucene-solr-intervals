...
public class TestNeedsScores extends LuceneTestCase {
  ...
  static class AssertNeedsScores extends Query {
    ...
    @Override
    public Weight createWeight(IndexSearcher searcher, final boolean needsScores, int flags) throws IOException {
      final Weight w = in.createWeight(searcher, needsScores, flags);
